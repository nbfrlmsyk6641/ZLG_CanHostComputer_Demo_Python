    ...
    def BtnOpenCAN_Click(self):
        if self._isChnOpen:
            ...
            if self._is_canfd:
                ...
                self._zcan.ZCAN_SetValue(self._dev_handle,"0/canfd_abit_baud_rate", str(1000000)); #设置仲裁域波特率
                self._zcan.ZCAN_SetValue(self._dev_handle,"0/canfd_dbit_baud_rate", str(5000000)); #设置数据域波特率
